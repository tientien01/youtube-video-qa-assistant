...
_configured_client_factory: Callable[[], LlmClient | None] | None = None
...
def build_configured_llm_client() -> LlmClient | None:
    return _configured_client_factory() if _configured_client_factory is not None else None


def configure_llm_client_factory(factory: Callable[[], LlmClient | None]) -> None:
    global _configured_client_factory
    _configured_client_factory = factory

...
class LocalIngestProcessor:
    """Runs the local transcript and rebuildable retrieval-index pipeline."""
        ...
        *,
        ...
        try:
            ...
            response = ingest_video_content(
                ...
                report_embedding=lambda: report_stage(IngestStage.EMBEDDING),
            )

...
- Chat history và workspace state mới lưu frontend localStorage, chưa sync backend.
- Summary/Notes/Quiz cached ở backend nhưng frontend chưa tự reload generated outputs khi chọn lại video.
- Quiz vẫn là fallback baseline, chưa dùng LLM để tạo câu hỏi chất lượng cao.
